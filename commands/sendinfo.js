    ...
    "bienvenue": [
        new EmbedBuilder()
            ...
            .addFields(
                ...
                {
                    name: "\u200B",
                    value: "> :seven: Il est **interdit** d'utiliser toute technique de **triche** sur les **serveurs Minecraft**, quelle qu'elle soit (AutoClick, X-Ray, Baritone, etc...). Si vous avez un doute sur l'utilisation d'un mod, contactez un membre du bureau. Veuillez noter que le bureau se réserve la discretion de définir ce qui confère un avantage injuste ou non."
                },
                {
                    name: "\u200B",
